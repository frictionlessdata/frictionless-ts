...
Defined in: metadata/build/field/types/Year.d.ts:5

Year field type

## Extends

- `BaseField`\<[`YearConstraints`](/reference/frictionless-ts/yearconstraints/)\>
...
> `optional` **constraints**: [`YearConstraints`](/reference/frictionless-ts/yearconstraints/)
...
Defined in: metadata/build/field/types/Year.d.ts:9
