...
- `BaseField`\<[`IntegerConstraints`](/reference/frictionless-ts/integerconstraints/)\>
...
> `optional` **constraints**: [`IntegerConstraints`](/reference/frictionless-ts/integerconstraints/)
