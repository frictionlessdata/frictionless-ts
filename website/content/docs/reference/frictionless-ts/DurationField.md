...
Defined in: metadata/build/field/types/Duration.d.ts:5

Duration field type (ISO 8601 duration)

## Extends

- `BaseField`\<[`DurationConstraints`](/reference/frictionless-ts/durationconstraints/)\>
...
> `optional` **constraints**: [`DurationConstraints`](/reference/frictionless-ts/durationconstraints/)
...
Defined in: metadata/build/field/types/Duration.d.ts:9
