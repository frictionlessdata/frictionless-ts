...
Defined in: metadata/build/field/types/Time.d.ts:5

Time field type

## Extends

- `BaseField`\<[`TimeConstraints`](/reference/frictionless-ts/timeconstraints/)\>
...
> `optional` **constraints**: [`TimeConstraints`](/reference/frictionless-ts/timeconstraints/)
...
Defined in: metadata/build/field/types/Time.d.ts:16
...
Defined in: metadata/build/field/types/Time.d.ts:9
