...
- `BaseField`\<[`StringConstraints`](/reference/frictionless-ts/stringconstraints/)\>
...
> `optional` **constraints**: [`StringConstraints`](/reference/frictionless-ts/stringconstraints/)
