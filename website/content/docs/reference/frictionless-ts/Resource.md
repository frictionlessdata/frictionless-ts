...
> `optional` **dialect**: `string` \| [`Dialect`](/reference/frictionless-ts/dialect/)
...
> `optional` **jsonSchema**: `string` \| [`Descriptor`](/reference/frictionless-ts/descriptor/)
...
> `optional` **licenses**: [`License`](/reference/frictionless-ts/license/)[]
...
> `optional` **schema**: `string` \| [`Schema`](/reference/frictionless-ts/schema/)
...
> `optional` **sources**: [`Source`](/reference/frictionless-ts/source/)[]
