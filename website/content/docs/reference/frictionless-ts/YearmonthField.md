...
Defined in: metadata/build/field/types/Yearmonth.d.ts:5

Year and month field type

## Extends

- `BaseField`\<[`YearmonthConstraints`](/reference/frictionless-ts/yearmonthconstraints/)\>
...
> `optional` **constraints**: [`YearmonthConstraints`](/reference/frictionless-ts/yearmonthconstraints/)
...
Defined in: metadata/build/field/types/Yearmonth.d.ts:9
