...
Defined in: metadata/build/field/types/Object.d.ts:5

Object field type (serialized JSON object)

## Extends

- `BaseField`\<[`ObjectConstraints`](/reference/frictionless-ts/objectconstraints/)\>
...
> `optional` **constraints**: [`ObjectConstraints`](/reference/frictionless-ts/objectconstraints/)
...
Defined in: metadata/build/field/types/Object.d.ts:9
