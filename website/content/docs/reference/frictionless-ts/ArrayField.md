...
Defined in: metadata/build/field/types/Array.d.ts:5

Array field type (serialized JSON array)

## Extends

- `BaseField`\<[`ArrayConstraints`](/reference/frictionless-ts/arrayconstraints/)\>
...
> `optional` **constraints**: [`ArrayConstraints`](/reference/frictionless-ts/arrayconstraints/)
...
Defined in: metadata/build/field/types/Array.d.ts:9
