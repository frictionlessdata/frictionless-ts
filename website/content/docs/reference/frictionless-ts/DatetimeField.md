...
- `BaseField`\<[`DatetimeConstraints`](/reference/frictionless-ts/datetimeconstraints/)\>
...
> `optional` **constraints**: [`DatetimeConstraints`](/reference/frictionless-ts/datetimeconstraints/)
