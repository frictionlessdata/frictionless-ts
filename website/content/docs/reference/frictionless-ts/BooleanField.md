...
- `BaseField`\<[`BooleanConstraints`](/reference/frictionless-ts/booleanconstraints/)\>
...
> `optional` **constraints**: [`BooleanConstraints`](/reference/frictionless-ts/booleanconstraints/)
