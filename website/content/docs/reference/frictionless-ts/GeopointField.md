...
Defined in: metadata/build/field/types/Geopoint.d.ts:5

Geopoint field type

## Extends

- `BaseField`\<[`GeopointConstraints`](/reference/frictionless-ts/geopointconstraints/)\>
...
> `optional` **constraints**: [`GeopointConstraints`](/reference/frictionless-ts/geopointconstraints/)
...
Defined in: metadata/build/field/types/Geopoint.d.ts:16
...
Defined in: metadata/build/field/types/Geopoint.d.ts:9
