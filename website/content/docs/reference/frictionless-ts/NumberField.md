...
- `BaseField`\<[`NumberConstraints`](/reference/frictionless-ts/numberconstraints/)\>
...
> `optional` **constraints**: [`NumberConstraints`](/reference/frictionless-ts/numberconstraints/)
