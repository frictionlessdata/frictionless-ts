...
- `BaseField`\<[`GeojsonConstraints`](/reference/frictionless-ts/geojsonconstraints/)\>
...
> `optional` **constraints**: [`GeojsonConstraints`](/reference/frictionless-ts/geojsonconstraints/)
