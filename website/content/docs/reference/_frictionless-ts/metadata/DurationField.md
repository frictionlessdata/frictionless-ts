...
Defined in: [field/types/Duration.ts:6](https://github.com/datisthq/frictionless-ts/blob/00601b0a4e9f476621340273fef9eeb54295b4e4/metadata/field/types/Duration.ts#L6)

Duration field type (ISO 8601 duration)

## Extends

- `BaseField`\<[`DurationConstraints`](/reference/_frictionless-ts/metadata/durationconstraints/)\>
...
> `optional` **constraints**: [`DurationConstraints`](/reference/_frictionless-ts/metadata/durationconstraints/)
...
Defined in: [field/types/Duration.ts:10](https://github.com/datisthq/frictionless-ts/blob/00601b0a4e9f476621340273fef9eeb54295b4e4/metadata/field/types/Duration.ts#L10)
