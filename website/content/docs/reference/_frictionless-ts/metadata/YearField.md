...
Defined in: [field/types/Year.ts:6](https://github.com/datisthq/frictionless-ts/blob/e0090ba3a6654c978542763fc4036b3a8316ee2a/metadata/field/types/Year.ts#L6)

Year field type

## Extends

- `BaseField`\<[`YearConstraints`](/reference/_frictionless-ts/metadata/yearconstraints/)\>
...
> `optional` **constraints**: [`YearConstraints`](/reference/_frictionless-ts/metadata/yearconstraints/)
...
Defined in: [field/types/Year.ts:10](https://github.com/datisthq/frictionless-ts/blob/e0090ba3a6654c978542763fc4036b3a8316ee2a/metadata/field/types/Year.ts#L10)
