...
Defined in: [field/types/Array.ts:6](https://github.com/datisthq/frictionless-ts/blob/00601b0a4e9f476621340273fef9eeb54295b4e4/metadata/field/types/Array.ts#L6)

Array field type (serialized JSON array)

## Extends

- `BaseField`\<[`ArrayConstraints`](/reference/_frictionless-ts/metadata/arrayconstraints/)\>
...
> `optional` **constraints**: [`ArrayConstraints`](/reference/_frictionless-ts/metadata/arrayconstraints/)
...
Defined in: [field/types/Array.ts:10](https://github.com/datisthq/frictionless-ts/blob/00601b0a4e9f476621340273fef9eeb54295b4e4/metadata/field/types/Array.ts#L10)
